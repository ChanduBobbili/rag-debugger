    ...
    <div className="rounded-xl border border-zinc-800 bg-zinc-900 overflow-hidden">
      <div className="flex items-center justify-between px-4 py-2.5 border-b border-zinc-800/50">
        <div className="flex items-center gap-2">
          <span className={cn("h-2 w-2 rounded-full", connected ? "bg-emerald-500 live-dot" : "bg-red-500")} />
              ...
              {events.map((event, i) => {
                ...
                return (
                  <motion.div
                    ...
                    className="flex items-center gap-2 px-4 py-2 border-b border-zinc-800/30 hover:bg-zinc-800/30 transition-colors"
                  >
                    <span className={cn("text-[9px] font-bold font-mono px-1.5 py-0.5 rounded shrink-0", cfg.bg, cfg.color)}>
                      {cfg.abbr}
                    </span>
